    ...
    <div className="car-form-wrapper">
      <Form onSubmit={onFormSubmit}>
        ...
        <Form.Group className="mb-3" controlId="endDate">
          <Form.Label style={{ fontWeight: "bold" }}>วันที่สิ้นสุด</Form.Label>
          <Form.Control
            type="date"
            name="endDate"
            value={rent.endDate}
        ...
        <Form.Group className="mb-3" controlId="totalCost">
          <Form.Label style={{ fontWeight: "bold" }}>ราคาสุทธิ:</Form.Label>
          <Col sm="10">
            <Form.Control
              plaintext
              readOnly
